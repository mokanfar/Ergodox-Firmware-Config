...
static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    KEYMAP(  // Layer0: default
        ...
        // right hand
             ...
             PPLS, N,   M,   COMM,DOT, SLSH,LSHIFT,
                       SPC, INS,  LGUI, DELETE,RBRC, FN5,FN6,
        QUOT,
        BTN4, FN8, RCTL
    ),
    ...
    KEYMAP(  // Layer2: Sublime
        ...
        TRNS,FN9,   TRNS,   TRNS,   TRNS,   TRNS,   FN0,
        TRNS,TRNS,   TRNS,   TRNS,   TRNS,   TRNS,
        TRNS,TRNS,   TRNS,   TRNS,   TRNS,   TRNS,   FN1,
        TRNS,TRNS,TRNS,TRNS,FN11,
                                      TRNS,TRNS,
                                           FN2,
                                 TRNS,TRNS,TRNS,
        // right hand
             TRNS,TRNS,TRNS,TRNS,FN16,FN17,TRNS,
             FN4,TRNS,   TRNS,   UP,   TRNS,   TRNS,   FN22,
                  HOME,   LEFT,   DOWN,   RIGHT,  END,   TRNS,
             TRNS,TRNS, TRNS,   FN10,FN12,TRNS,TRNS,
                       FN11,TRNS,TRNS,TRNS, TRNS,
        TRNS,TRNS,
        TRNS,
        TRNS,TRNS,TRNS
    ),
        ...
        // left hand
        TRNS,F1,TRNS,BTN2,TRNS,BTN1,TRNS,
        TRNS,FN13,FN12,FN18,TRNS,FN16,TRNS,
        TRNS,FN20,TRNS,TRNS,TRNS,TRNS,
        TRNS,TRNS,TRNS,TRNS,TRNS,FN14,TRNS,
        ...
        // right hand
             ...
             BTN4,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
...
static const uint16_t PROGMEM fn_actions_2[] ={
    ...
    [0] =  ACTION_MODS_KEY(MOD_LCTL|MOD_LSFT, KC_F4), //ctrl+shift+f4
    [16] =  ACTION_MODS_KEY(MOD_LCTL|MOD_LSFT, KC_F9), //ctrl+shift+f9
    [17] =  ACTION_MODS_KEY(MOD_LCTL|MOD_LSFT, KC_F10), //ctrl+shift+f10
    [1] =  ACTION_MODS_KEY(MOD_LCTL|MOD_LSFT, KC_F11), //ctrl+shift+f11
    [22] =  ACTION_LAYER_SET_CLEAR(0), //Layer[0]
    [2] =  ACTION_MODS_KEY(MOD_LCTL|MOD_LSFT, KC_F7), //ctrl+shift+f7
    //temporarily disabled FN3 to test momentary switching
    [3] =  ACTION_MODS_KEY(MOD_LCTL|MOD_LSFT, KC_F6), //ctrl+shift+f6
    [4] =   ACTION_MODS_KEY(MOD_LCTL|MOD_LALT, KC_F9),//expand word
    [5] =  ACTION_MODS_KEY(MOD_LCTL, KC_QUOT), //quote
    [6] =  ACTION_MODS_KEY(MOD_LCTL|MOD_LSFT, KC_A), //expand line
    [7] =  ACTION_MODS_KEY(MOD_LCTL|MOD_LALT, KC_F10), //expand brackets
    [11] =  ACTION_MODS_KEY(MOD_LCTL|MOD_LSFT, KC_SPACE), //Expand to Space
...
static const uint16_t PROGMEM fn_actions_4[] = {
    ...
    [20] = ACTION_LAYER_SET_CLEAR(0), //ctrl+shift+f11

};

static const uint16_t PROGMEM fn_actions_3[] = {

[12]=ACTION_MODS_KEY(MOD_LALT,KC_W),//ctrl+0
[13]=ACTION_MODS_KEY(MOD_LCTL,KC_Q),//ctrl+0
[14]=ACTION_MODS_KEY(MOD_LALT,KC_B),//ctrl+0
[15]=ACTION_MODS_KEY(MOD_LCTL,KC_L),//ctrl+0
[16]=ACTION_MODS_KEY(MOD_LCTL|MOD_LSFT,KC_A),//ctrl+0
[17]=ACTION_MODS_KEY(MOD_LCTL|MOD_LSFT,KC_SPACE),//ctrl+0
[18]=ACTION_MODS_KEY(MOD_LALT,KC_E),//ctrl+0
[19]=ACTION_MODS_KEY(MOD_LCTL,KC_SCLN),//LaunchyCtrl+;
[20]=ACTION_MODS_KEY(MOD_LALT|MOD_LSFT,KC_A),//LaunchyCtrl+;
